...
<body class="bg-gray-100 dark:bg-slate-900">
    ...
    <!-- Mobile Menu Button -->
    <button id="mobileBtn" class="fixed top-6 left-6 z-50 p-2 rounded-lg bg-purple-600 text-white block md:hidden"
    ...
    <div class="min-h-screen flex flex-row">
        ...
        <div class="min-h-screen ml-5 fixed left-0 md:relative">
            <aside id="sidebarContainer" class="sidebar" side='close'>
                <header class="flex items-center justify-between p-4 border-purple-500 cursor-pointer" onclick="toggleSidebar()">
                    <p class="text-yellow-300 text-3xl font-semibold font-oswald expandIcon">A<span class="text-white">bsensi</span></p>
                    <svg class="w-10 h-10 text-white expandIcon"aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 17.94 6M18 18 6.06 6" />
                    </svg>
                    <svg width="30" height="30" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                        style="cursor: pointer;" id="collapseIcon">
                ...
                <div class="p-4 space-y-4">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="flex items-center gap-3 text-white cursor-pointer text-lg mt-40">
    ...
    <script>
        ...
        function toggleSidebar() {
            const currentSidebar = sidebar.getAttribute('side');
            currentSidebar == 'close' ? sidebar.setAttribute('side', 'open') : sidebar.setAttribute('side', 'close');
        }
    </script>
</body>
