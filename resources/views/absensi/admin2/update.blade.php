                ...
                <form action="{{ route('admin.update_process', $data->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="password" id="password"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-purple-600 focus:border-transparent dark:bg-gray-700 dark:text-white @error('name') border-red-500 @enderror" value="password123">
