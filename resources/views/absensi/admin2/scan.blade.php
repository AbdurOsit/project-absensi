...
@section('admin2')
    <div class="w-full max-w-md">
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
            ...
            <!-- Card Scan Area -->
            <div
                class="relative h-64 rounded-lg border-2 border-dashed border-zinc-600 hover:border-zinc-400 transition-colors duration-300 overflow-hidden">
                <!-- Initial State -->
                <div id="initial-state" class="relative h-full flex flex-col items-center justify-center text-center">
                    <!-- Hand holding card icon -->
                    <svg class="w-20 h-20 text-zinc-400 mb-3" xmlns="http://www.w3.org/2000/svg" fill="none"
