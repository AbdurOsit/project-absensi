            ...
            <div class="p-4">
                <form action="{{ route('kegiatan.create') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="kegiatan" id="kegiatan" class="w-full h-32 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-purple-600 focus:border-transparent dark:bg-gray-700 dark:text-white">{{ old('kegiatan') }}</textarea>
