    ...
    <div class="min-h-screen flex flex-row ">
        ...
        <div class="min-h-screen ml-5 fixed left-0 md:relative">
            <aside id="sidebarContainer" class="sidebar" side='close'>
                <header class="flex items-center justify-between p-4 border-purple-500 cursor-pointer"
                    onclick="toggleSidebar()">
                ...
                <div class="p-4">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit"
                            class="flex items-center gap-3 text-white cursor-pointer text-lg mt-20">
