...
<div id="subcontent">
  <div class="p-2 font-sans">
    ...
    <!-- Profile Card -->
    <div class="mx-6 bg-gray-800 p-6 rounded-lg flex items-center gap-4 text-white" id="profile">
      <img
    ...
    const subcontent = document.getElementById('subcontent');
        function setTheme(theme) {
            if (theme === 'sun') {
                ...
                subcontent.classList.add('text-black');
                
            } else {
                //jika mode Dark
                
                subcontent.classList.remove('text-black');
                subcontent.classList.add('text-white');
